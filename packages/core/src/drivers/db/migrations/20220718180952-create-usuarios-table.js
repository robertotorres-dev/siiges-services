...
const { CONFIGURACION_INTEGRACION_TABLE, ConfiguracionIntegracionSchema } = require('../models/configuracionIntegracion');
...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.createTable(
      CONFIGURACION_INTEGRACION_TABLE,
  ...
  async down(queryInterface) {
    ...
    await queryInterface.dropTable(CONFIGURACION_INTEGRACION_TABLE);
